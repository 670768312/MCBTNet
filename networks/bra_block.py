...
class Block(nn.Module):
    ...
    def forward(self, x):
        ...
        # 打印整个层的输入尺寸
        print(f"\nProcessing BRA Layer:")
        print(f"Input dimensions (H, W, C): ({H}, {W}, {C})")
        ...
        print(f"Region (window) count and dimensions:")
        print(f"Total regions: {H // self.attn.n_win} x {W // self.attn.n_win}")
        print(f"Each region dimensions (H, W, C): ({self.attn.n_win}, {self.attn.n_win}, {C})")
