...
class BiLevelRoutingAttention(nn.Module):
    ...
    def forward(self, x, ret_attn_mask=False):
        ...
        Return:
            NHWC tensor
        """
        #print(f'x_as attetnion input',x.shape)
        ...
        #print(f'x_after embedding:', x.shape)
        #################qkv projection###################
        # q: (n, p^2, w, w, c_qk)
        ...
        # param-free multihead attention2
        ...
        # output linear
        out = self.wo(out)
        #print(f"r_weight.shape:",r_weight.shape,f"r_idx.shape:",r_idx.shape,f'attn_weight.shape:',attn_weight.shape)

        global_attenmap.set_value(r_idx,attn_weight)
        global_attenmap.get_len()
